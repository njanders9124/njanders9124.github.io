...
<img class="ui medium right floated rounded image" src="../images/1040EZ">
...
<img class="ui medium right floated rounded image" src="../images/TurboTax">
...
I understand that some other factors are influencing those percentages, such as the increasing prevalence of the internet and people manually E-filing, but 
